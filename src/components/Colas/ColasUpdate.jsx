...
export default function ColasUpdate({colaData,id_empresa}) {
  ...
  useEffect(() => {
    empresaData.filter(empresa => {
        ...
        if (Number(id_empresa) === empresa.e_id) {
            ...
            if (colaData[0]!==undefined) {
                ...
                setformValues({
                    ...
                    description:colaData[0].descripcion,
                    carpeta:colaData[0].carpeta, //nombreCarpeta carpeta
                    empresa_id: colaData[0].empresa_id,
                    format:colaData[0].format,
                    stamp: null,
                    save:null,
                    error:null,
                    directory:colaData[0].directory,
                    estado:null,
                    audioId:colaData[0].id,
                    currentEmpId:colaData[0].empresa_id
  ...
  }, [empresaData, setNombreEmpresa,setformValues,colaData])
  ...
  useEffect(() => {
    ...
    if (empresaInput !== undefined) {
      ...
      setformValues({ ...formValues, carpeta:empresa, empresa_id: id,currentEmpId:colaData[0].empresa_id });
    }
  }, [empresaInput]);
          ...
          <div className="form-group col-12 col-md-6 col-lg-6 ">
            ...
            <select
             // disabled
              ...
              defaultValue=""
            >
              <option hidden value={id_empresa}>{NombreEmpresa}</option>
